...
public class Itemlist {
    ...
    public static Item Drink(int hunger, float saturation, boolean isMeat, boolean fastFood, boolean alwaysEat, MobEffect[] effects, int getEffectTime, int getEffectLever, float random) {
        Properties Properties = new Properties();
        Properties.tab(Withfire.TAB);
        Builder Builder = new Builder();
        Builder.nutrition(hunger);
